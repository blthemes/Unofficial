...
<xsl:template match="/">
	...
	<head>
		<title>XML Sitemap - <?php echo $site->title(); ?></title>
	...
	<div id="description">
		<h1>XML Sitemap</h1>
		<p>This XML Sitemap is generated by <a href="https://github.com/bludit/bludit/tree/master/bl-plugins/sitemap" target="_blank">Bludit Sitemap Plugin</a>. It is what search engines like Google use to crawl and re-crawl posts/pages/products/images/archives on your website.</p>
	...
	<div id="content">
		...
		<xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &lt; 1">
			...
			<p class="expl"><a href="<?php echo Theme::sitemapUrl(); ?>">&#8592; Sitemap Index</a></p>
			<table id="sitemap" cellpadding="3">
				<thead>
				<tr>
					<th width="80%">URL</th>					
